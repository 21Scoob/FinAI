// src/components/CheltuieliEnvelope.js
"use client";

import React from "react";

export default function CheltuieliEnvelope({ icon, name, allocated, spent }) {
  ...
  return (
    <div className="rounded-lg p-5 shadow-lg flex flex-col justify-between bg-zinc-900/60 border border-zinc-800">
        ...
        <div className="w-full bg-zinc-700 rounded-full h-2.5">
          <div
            className={`h-2.5 rounded-full ${
              remainingColor === "text-red-400" ? "bg-red-500" : "bg-orange-500"
            }`}
